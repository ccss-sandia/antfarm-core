    ...
    class IpInterface
      ...
      def create_layer3_interface
        ...
        unless self.layer3_interface
          layer3_interface = Antfarm::Models::Layer3Interface.new :certainty_factor => 0.75
          ...
          if layer3_interface.save
            ...
            Antfarm::Helpers.log :warn, "IpInterface: Errors occured while creating Layer 3 Interface. Now printing errors."
