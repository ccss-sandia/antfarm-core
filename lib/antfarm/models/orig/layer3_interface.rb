...
module Antfarm
  module Models
    class Layer3Interface
      ...
      property :id,                  Serial
      property :layer2_interface_id, Integer, :nullable => false
      property :layer3_network_id,   Integer, :nullable => false
...
#     before :create, :create_layer3_network
      ...
      def initialize(*args)
        super
        Antfarm::Helpers.log :warn, "Hello"
      end
      ...
      def create_layer3_network
        Antfarm::Helpers.log :info, 'Creating Layer 3 Network'
        ...
        unless self.layer3_network
          ...
          if layer3_network.save
            ...
            Antfarm::Helpers.log :warn, "Layer3Interface: Errors occured while creating Layer 3 Network. Now printing errors."
            layer3_network.errors.each do |msg|
          ...
          Antfarm::Helpers.log :info, 'Layer 3 Network already set'
        end
      end

      def create_layer2_interface
        Antfarm::Helpers.log :info, 'Creating Layer 2 Interface'
        ...
        unless self.layer2_interface
          ...
          Antfarm::Helpers.log :info, 'Layer 2 Interface already set'
        end
      end
