...
# of a layer 2 interface model. TODO: what?! <scrapcoder>
#
# Save
#
...
describe Antfarm::Model::EthernetInterface, '#create' do
  ...
  it 'should create a new layer 2 interface' do
    ...
    iface.save
    iface.layer2_interface.should_not == nil
    Antfarm::Model::Layer2Interface.all.length.should == count + 1
    iface.layer2_interface.should == Antfarm::Model::Layer2Interface.all.last
  end

  it 'should use a given certainty factor when creating a new layer 2 interface' do
    count = Antfarm::Model::Layer2Interface.all.length
    iface = Antfarm::Model::EthernetInterface.new
    iface.address = '00:00:00:00:00:00'
    iface.layer2_interface = { :certainty_factor => 0.5 }
    iface.save
    iface.layer2_interface.should_not == nil
    Antfarm::Model::Layer2Interface.all.length.should == count + 1
    iface.layer2_interface.should == Antfarm::Model::Layer2Interface.all.last
    iface.layer2_interface.certainty_factor.should == 0.5
  end

  it 'should use a given layer 2 interface' do
    count = Antfarm::Model::Layer2Interface.all.length
    l2_iface = Antfarm::Model::Layer2Interface.create
    Antfarm::Model::Layer2Interface.all.length.should == count + 1
    Antfarm::Model::Layer2Interface.all.last.should == l2_iface
    iface = Antfarm::Model::EthernetInterface.new
    iface.address = '00:00:00:00:00:00'
    iface.layer2_interface = l2_iface
    iface.save
    iface.layer2_interface.should_not == nil
    iface.layer2_interface.should == l2_iface
  end
end
